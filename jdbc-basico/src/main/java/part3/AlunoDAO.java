...
public class AlunoDAO {
    ...
    //preparar lista que ira retornar alunos após consultar o banco de dados;
    ...
    PreparedStatement prst = conn.prepareStatement("SELECT * FROM ALUNO");
        ...
        //posicinando o cursor para o próximo registro após o void
        while(rs.next()){

            //cria objeto para popular lista com resultado do select
